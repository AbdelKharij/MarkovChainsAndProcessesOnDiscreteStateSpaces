...
% Theorem environments (ximera provides theorem/definition natively,
% but we redefine to match the original style)
...
\end{tikzpicture}
\caption{Figure 1: The simple random walk on a ring with five lattice sites.}
\label{markov-ring}
\end{figure}
